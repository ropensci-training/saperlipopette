...
git_links <- function() {
  ...
  tibble::tribble(
    ...
    "log_string"    , "git log -S<string>"           , "https://git-scm.com/docs/git-log#Documentation/git-log.txt--Sstring"            ,
    "log_regex"     , "git log -G<regex>"            , "https://git-scm.com/docs/git-log#Documentation/git-log.txt--Gregex"             ,
    "log_path"      , "git log -- <path>"            , "https://git-scm.com/docs/git-log#Documentation/git-log.txt---path"              ,
