...
- [ ] If the `@git` tag references new git commands, add entries in `R/roxygen2.R` `git_links()` with the command name, display name, and URL
- [ ] Create `inst/exo_<exercise_name>-Rprofile.en.R` with the challenge prompt and `tip()` function
