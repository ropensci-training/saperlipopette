...
[![Status at rOpenSci Software Peer Review](https://badges.ropensci.org/754_status.svg)](https://github.com/ropensci/software-review/issues/754)
<!-- badges: end -->

The goal of saperlipopette is to hold functions creating Git exercises, 
that users solve using their local and usual tools.

Teachers can use the package when teaching intermediate Git by
creating commonly-encountered version control challenges and providing guidance
to resolving the challenges.
Learners can also use the various exercises on their own to learn Git concepts.
