...
#> ℹ Follow along in /tmp/RtmpQOPptZ/file1c532c6eb956/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpQOPptZ/file1c532c6eb956/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpQOPptZ/file1c531cc776aa/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpQOPptZ/file1c531df27a7f/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpQOPptZ/file1c53134d007d/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpQOPptZ/file1c53134d007d/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
