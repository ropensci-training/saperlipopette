...
#> ℹ Follow along in /tmp/RtmpxQ6iju/file1d6d20e491eb/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpxQ6iju/file1d6d20e491eb/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpxQ6iju/file1d6d519547ac/one-small-change
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpxQ6iju/file1d6d1dc8712e/one-small-change
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpxQ6iju/file1d6d109d1697/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpxQ6iju/file1d6d109d1697/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
