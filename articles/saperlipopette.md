...
#> ℹ Follow along in /tmp/RtmpwAvHr1/file1c2c22642076/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpwAvHr1/file1c2c22642076/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpwAvHr1/file1c2c5506f625/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpwAvHr1/file1c2c7bf0b888/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpwAvHr1/file1c2c60197a48/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpwAvHr1/file1c2c60197a48/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
