...
#> ℹ Follow along in /tmp/Rtmphy2vyR/file1d9736fd0d7c/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/Rtmphy2vyR/file1d9736fd0d7c/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/Rtmphy2vyR/file1d9759c3adf3/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/Rtmphy2vyR/file1d97553de2fb/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/Rtmphy2vyR/file1d971057e6bb/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/Rtmphy2vyR/file1d971057e6bb/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
