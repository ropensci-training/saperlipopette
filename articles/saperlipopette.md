...
#> ℹ Follow along in /tmp/RtmpJXaQob/file1db9fbe30e1/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpJXaQob/file1db9fbe30e1/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpJXaQob/file1db976ffc894/one-small-change
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpJXaQob/file1db914275960/one-small-change
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpJXaQob/file1db921ff180e/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpJXaQob/file1db921ff180e/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
