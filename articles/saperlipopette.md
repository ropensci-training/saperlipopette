...
#> ℹ Follow along in /tmp/RtmppDwOVf/file1cda45a2c18f/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmppDwOVf/file1cda45a2c18f/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmppDwOVf/file1cda4ef588e1/one-small-change
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmppDwOVf/file1cda1d8527af/one-small-change
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmppDwOVf/file1cda393f6313/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmppDwOVf/file1cda393f6313/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
