...
#> ℹ Follow along in /tmp/RtmpljioX4/file1c4a3c0f5354/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpljioX4/file1c4a3c0f5354/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpljioX4/file1c4a435a1e1c/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpljioX4/file1c4a1d732da3/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpljioX4/file1c4a2009f70/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpljioX4/file1c4a2009f70/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
