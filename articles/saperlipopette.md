...
#> ℹ Follow along in /tmp/RtmpZCH1rE/file1c674ed557c3/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpZCH1rE/file1c674ed557c3/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpZCH1rE/file1c678d843ea/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpZCH1rE/file1c67325d7c76/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpZCH1rE/file1c6713c79f97/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpZCH1rE/file1c6713c79f97/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
