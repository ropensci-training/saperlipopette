...
#> ℹ Follow along in /tmp/RtmpnmJr85/file1c5c13c412ec/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpnmJr85/file1c5c13c412ec/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpnmJr85/file1c5c7878426f/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpnmJr85/file1c5c5570ffb5/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpnmJr85/file1c5c6a170661/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpnmJr85/file1c5c6a170661/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
