...
#> ℹ Follow along in /tmp/RtmpWyxI8M/file1c3377085519/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpWyxI8M/file1c3377085519/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpWyxI8M/file1c33356eb2e5/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpWyxI8M/file1c333c94353/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpWyxI8M/file1c335f00f2d9/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpWyxI8M/file1c335f00f2d9/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
