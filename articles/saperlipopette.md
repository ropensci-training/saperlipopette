...
#> ℹ Follow along in /tmp/RtmpSSzw1Q/file1c573e714821/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpSSzw1Q/file1c573e714821/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpSSzw1Q/file1c5721087eea/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpSSzw1Q/file1c57431548d/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpSSzw1Q/file1c571c674043/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpSSzw1Q/file1c571c674043/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
