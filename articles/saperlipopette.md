...
#> ℹ Follow along in /tmp/RtmpneNOoW/file1d557aedd1d8/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpneNOoW/file1d557aedd1d8/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpneNOoW/file1d555216bf6/one-small-change
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpneNOoW/file1d552e6f8af1/one-small-change
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpneNOoW/file1d554408373c/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpneNOoW/file1d554408373c/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
