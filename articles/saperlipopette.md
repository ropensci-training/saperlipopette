...
#> ℹ Follow along in /tmp/RtmpAEKZYG/file1e833db95271/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpAEKZYG/file1e833db95271/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpAEKZYG/file1e836e5ff70e/one-small-change
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpAEKZYG/file1e8352f4f958/one-small-change
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpAEKZYG/file1e833c4af14d/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpAEKZYG/file1e833c4af14d/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
