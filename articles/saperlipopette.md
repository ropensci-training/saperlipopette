...
#> ℹ Follow along in /tmp/Rtmpn0thMk/file1d104cbff2fb/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/Rtmpn0thMk/file1d104cbff2fb/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/Rtmpn0thMk/file1d105b7addfa/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/Rtmpn0thMk/file1d104962c65a/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/Rtmpn0thMk/file1d102b87f6e0/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/Rtmpn0thMk/file1d102b87f6e0/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
