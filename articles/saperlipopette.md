...
#> ℹ Follow along in /tmp/RtmpJJooaU/file1d24772ddd3/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpJJooaU/file1d24772ddd3/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpJJooaU/file1d242f13ec6e/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpJJooaU/file1d246ad4027f/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpJJooaU/file1d241eebe5f5/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpJJooaU/file1d241eebe5f5/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
