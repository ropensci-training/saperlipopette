...
#> ℹ Follow along in /tmp/RtmpwS10nt/file1ca658b600bd/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpwS10nt/file1ca658b600bd/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpwS10nt/file1ca660de478d/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpwS10nt/file1ca618a56f4a/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpwS10nt/file1ca6d9eda45/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpwS10nt/file1ca6d9eda45/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
