...
#> ℹ Follow along in /tmp/RtmpFnkXOy/file1c3d7dd780c4/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpFnkXOy/file1c3d7dd780c4/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpFnkXOy/file1c3d3ecdb758/one-small-change!
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpFnkXOy/file1c3d38a4aba0/one-small-change!
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpFnkXOy/file1c3d423a506a/one-small-change!
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpFnkXOy/file1c3d423a506a/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
