...
#> ℹ Follow along in /tmp/RtmpNL1d7X/file1d4e6dd640ef/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpNL1d7X/file1d4e6dd640ef/one-small-change
#> ├── R
#> └── bla
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpNL1d7X/file1d4e3d426704/one-small-change
gert::git_log(repo = path)
#> # A tibble: 2 × 6
#>   commit                          author time                files merge message
#> * <chr>                           <chr>  <dttm>              <int> <lgl> <chr>  
...
#> ℹ Follow along in /tmp/RtmpNL1d7X/file1d4e28a4ea54/one-small-change
...
parent_path <- withr::local_tempdir()
path <- exo_one_small_change(parent_path)
#> ℹ Follow along in /tmp/RtmpNL1d7X/file1d4e34f0b57f/one-small-change
# what's in path
fs::dir_tree(path)
#> /tmp/RtmpNL1d7X/file1d4e34f0b57f/one-small-change
#> ├── R
#> └── bla
# with Git in a command line: git log
# or the gert R package
